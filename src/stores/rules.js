...
const builtinRules = [
  ...
  },
  {
    ...
    description: '检测设备MAC地址',
    enabled: true,
    strategy: 'partial_mask',
    strategyConfig: { keepStart: 0, keepEnd: 2, maskChar: '*' },
    needLuhnCheck: false,
    mode: 'regex'
  },
  {
  ...
  },
  {
    ...
    description: '检测API密钥、Token等敏感配置',
    enabled: true,
    strategy: 'full_mask',
    strategyConfig: { keepStart: 0, keepEnd: 0, maskChar: '*' },
    needLuhnCheck: false,
  ...
  },
  {
    ...
    type: 'address',
    pattern: '',
    description: '详细地址信息（需NER支持）',
    enabled: false,
    strategy: 'partial_mask',
    strategyConfig: { keepStart: 6, keepEnd: 0, maskChar: '*' },
    needLuhnCheck: false,
    mode: 'regex'
  },
  {
    ...
    enabled: true,
    strategy: 'partial_mask',
    strategyConfig: { keepStart: 0, keepEnd: 1, maskChar: '*' },
    needLuhnCheck: false,
    mode: 'regex'
  },
  {
  ...
  },
  {
    ...
    description: '检测固定电话号码',
    enabled: true,
    strategy: 'partial_mask',
    strategyConfig: { keepStart: 3, keepEnd: 3, maskChar: '*' },
    needLuhnCheck: false,
    mode: 'regex'
  },
  {
